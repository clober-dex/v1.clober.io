...
export interface MockPriceBookInterface extends utils.Interface {
  functions: {
...
export interface MockPriceBook extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockPriceBookInterface;
  ...
  functions: {
    ...
    priceToIndex(
      ...
      roundingUp: boolean,
      overrides?: CallOverrides
    ): Promise<[number, BigNumber] & { priceIndex: number }>;
