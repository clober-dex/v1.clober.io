...
export interface CloberPriceBookInterface extends utils.Interface {
  functions: {
...
export interface CloberPriceBook extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CloberPriceBookInterface;
