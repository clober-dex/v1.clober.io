...
export interface ArithmeticPriceBookInterface extends utils.Interface {
  functions: {
...
export interface ArithmeticPriceBook extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArithmeticPriceBookInterface;
